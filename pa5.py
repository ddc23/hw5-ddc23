...
def gcd(a, b):
    """
    Compute the greatest common divisor of two number
...
def bisection_root(f, a, b, tol=1e-6):
    """
    Find the root of a function within an interval [a, b]
using the bisection method.
    ...
    """
    if f(a) * f(b) >= 0:
        raise ValueError("The function does not change signs\
